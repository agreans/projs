...
(function(f) {
    ...
    q.defaults = {
        ...
        oLanguage: {
            oAria: {
                sSortAscending: ": Отсортируйте по возростанию",
                sSortDescending: ": Отсортируйте по убыванию"
            },
            oPaginate: {
                sFirst: "Первый",
                sLast: "Последний",
            ...
            sInfoFiltered: "(Показано _MAX_ записей)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            ...
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "Записей не обранужено"
        },
